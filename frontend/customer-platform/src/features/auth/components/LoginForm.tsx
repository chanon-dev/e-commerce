...
const LoginForm = ({ onSuccess, redirectTo = '/' }: LoginFormProps) => {
  ...
  const handleSocialLogin = async (provider: 'google' | 'facebook') => {
    try {
      ...
      const authUrl = `${keycloakUrl}/realms/ecommerce/protocol/openid-connect/auth?client_id=${clientId}&redirect_uri=${redirectUri}&response_type=code&scope=openid&kc_idp_hint=${provider}`;
